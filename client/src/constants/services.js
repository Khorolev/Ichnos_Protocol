export const SERVICES_LIST = [
  ...
  },
  {
    ...
    title: 'Battery Passport Development (In-House)',
    description:
...
export const BATTERY_PASSPORT_FEATURES = [
  { feature: 'Composition & Materials Data', mandated: true, status: 'Live', phase: 'Prototype' },
  { feature: 'Performance & Durability Metrics', mandated: true, status: 'Live', phase: 'Prototype' },
  ...
  { feature: 'Remanufacturing Readiness Score', mandated: false, status: 'In Development', phase: 'Prototype' },
  { feature: 'Second-Life Application Matching', mandated: false, status: 'Planned', phase: 'Production' },
  { feature: 'SME Marketplace Integration', mandated: false, status: 'Planned', phase: 'Production' },
...
export const ROADMAP_PHASES = [
  ...
  },
  {
    ...
    badge: 'PLANNED',
    description:
      'Migration to Solana blockchain for immutable, decentralized battery lifecycle records with transparent provenance and interoperability.',
    features: [
