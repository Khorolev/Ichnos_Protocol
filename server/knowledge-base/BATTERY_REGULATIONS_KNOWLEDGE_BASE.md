...
> **Generated**: 2026-02-17 | **Updated**: 2026-03-05 (161 PDFs downloaded, 159 converted & ingested into Firestore)
...
| Icon                   | Meaning                                            |
| ---------------------- | -------------------------------------------------- |
| :white_check_mark:     | Downloaded — PDF saved locally                     |
| :globe_with_meridians: | Free — available online, not yet downloaded        |
| :lock:                 | Authentication required                            |
| :moneybag:             | Paid — purchase required (price noted where known) |

---

## Table of Contents

1. [EU Battery Regulation & Related EU Legislation](#1-eu-battery-regulation--related-eu-legislation)
2. [UNECE Vehicle Regulations & Homologation](#2-unece-vehicle-regulations--homologation)
3. [IEC/ISO Battery Standards](#3-ieciso-battery-standards)
4. [Battery Passport & Digital Product Passport](#4-battery-passport--digital-product-passport)
5. [Supply Chain Due Diligence](#5-supply-chain-due-diligence)
6. [Transport of Dangerous Goods](#6-transport-of-dangerous-goods)
7. [Safety, Recycling & Environmental](#7-safety-recycling--environmental)
8. [Functional Safety & Testing](#8-functional-safety--testing)
9. [China Regulations](#9-china-regulations)
10. [ASEAN Regulations](#10-asean-regulations)
11. [Eurasian Economic Union (EAEU)](#11-eurasian-economic-union-eaeu)
12. [Middle East Regulations](#12-middle-east-regulations)
13. [Africa Regulations](#13-africa-regulations)
14. [Global Market & Policy Reports](#14-global-market--policy-reports)

---

## 1. EU Battery Regulation & Related EU Legislation

### 1.1 Core Battery Regulation
...
| 8   | Implementing Reg. — Collection Rates & Recycling Efficiencies    | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | Expected 2025                                                                                               |
| 9   | Delegated Reg. — Recycled Content Methodology                    | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | Expected 2025                                                                                               |
| 10  | Delegated Reg. — Performance & Durability (EV batteries)         | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | Minimum performance thresholds                                                                              |
| 11  | Delegated Reg. — Electrochemical Performance & Durability (LMT)  | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | LMT-specific performance thresholds                                                                         |
| 12  | Delegated Reg. — Safety Parameters (stationary BESS)             | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | Safety requirements for stationary storage                                                                  |
| 13  | Delegated Reg. — Green Public Procurement Criteria               | :globe_with_meridians: Free   | EUR-Lex (pending)                                                                   | GPP criteria for batteries                                                                                  |

### 1.2 Related EU Legislation

| #   | Document                                                     | Status                        | URL                                                                                  | Notes                                    |
| --- | ------------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------- |
| 14  | **EU Type Approval Regulation 2018/858**                     | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32018R0858)  | Vehicle type-approval framework          |
| 15  | **EU General Product Safety Regulation 2023/988**            | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32023R0988)  | General product safety requirements      |
| 16  | **REACH Regulation 1907/2006**                               | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32006R1907)  | Chemical substances regulation           |
| 17  | **RoHS Directive 2011/65/EU**                                | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32011L0065)  | Restriction of hazardous substances      |
| 18  | **Waste Framework Directive 2008/98/EC**                     | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32008L0098)  | Waste hierarchy and management           |
| 19  | **End-of-Life Vehicles Regulation 2023** (proposal)          | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:52023PC0451) | ELV regulation proposal                  |
| 20  | **EU Conflict Minerals Regulation 2017/821**                 | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32017R0821)  | Conflict minerals due diligence          |
| 21  | **CSDDD 2024/1760** (Corporate Sustainability Due Diligence) | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024L1760)  | Corporate due diligence obligations      |
| 22  | **Ecodesign for Sustainable Products Regulation 2024**       | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024R1781)  | Digital Product Passport framework       |
| 23  | **Packaging and Packaging Waste Regulation 2025**            | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32025R0040)  | Packaging requirements for batteries     |
| 24  | **Low Voltage Directive 2014/35/EU**                         | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32014L0035)  | Electrical safety requirements           |
| 25  | **Machinery Regulation 2023/1230**                           | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32023R1230)  | Machinery safety (incl. battery-powered) |
| 26  | **ATEX Directive 2014/34/EU**                                | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32014L0034)  | Explosive atmospheres equipment          |
| 27  | **CLP Regulation 1272/2008**                                 | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32008R1272)  | Classification, labelling, packaging     |
| 28  | **Seveso III Directive 2012/18/EU**                          | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32012L0018)  | Major-accident hazards                   |
| 29  | **WEEE Directive 2012/19/EU**                                | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32012L0019)  | Waste electrical & electronic equipment  |
| 30  | **EU Critical Raw Materials Act 2024/1252**                  | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024R1252)  | Critical raw materials supply chains     |
| 31  | **Waste Shipment Regulation 2024/1157**                      | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024R1157)  | Transboundary waste shipment rules       |
| 32  | **EU Taxonomy Regulation 2020/852**                          | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32020R0852)  | Sustainable finance taxonomy             |
| 33  | **CSRD 2022/2464** — Corporate Sustainability Reporting      | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32022L2464)  | Sustainability reporting obligations     |
| 34  | **EMC Directive 2014/30/EU**                                 | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32014L0030)  | Electromagnetic compatibility            |
| 35  | Regulation on CO2 emission standards for cars/vans 2023/851  | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32023R0851)  | CO2 fleet targets                        |

---

## 2. UNECE Vehicle Regulations & Homologation

### 2.1 Core EV Battery Regulations

| #   | Document                                         | Status                        | URL                                                                                                                 | Notes                                                                                                                                             |
| --- | ------------------------------------------------ | ----------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| 36  | **UNECE R100 Rev.3** — Electric Vehicle Safety   | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2024-01/R0100r3e.pdf)                                                 | Mandatory for EV type-approval in UNECE countries                                                                                                 |
...
| #   | Document                                             | Status                        | URL                                                                               | Notes                             |
| --- | ---------------------------------------------------- | ----------------------------- | --------------------------------------------------------------------------------- | --------------------------------- |
| 46  | **1958 Agreement** (UNECE Vehicle Regulations) Rev.3 | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-03/1958-Agreement-Rev.3-E.pdf) | Legal framework for type-approval |
| 47  | **1998 Agreement** (Global Technical Regulations)    | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-03/1998-Agreement-E.pdf)       | Legal framework for GTRs          |

### 2.4 Additional UNECE Regulations

| #   | Document                                                | Status                        | URL                                                                                    | Notes                                |
| --- | ------------------------------------------------------- | ----------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------ |
| 48  | UNECE R13 — Heavy Vehicle Braking                       | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-10/R013r8e.pdf)                     | Regenerative braking provisions      |
| 49  | UNECE R13-H — Passenger Vehicle Braking                 | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-10/R013hr1e.pdf)                    | Light vehicle braking (incl. regen)  |
| 50  | UNECE R79 — Steering Equipment                          | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-10/R079r3e.pdf)                     | ADAS-relevant for EVs                |
| 51  | UNECE R153 — Fuel System Integrity (Rear-End Collision) | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2023-02/R153e.pdf)                       | Adapted for EVs                      |
| 52  | UNECE R155 — Cybersecurity                              | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-03/R155e.pdf)                       | Vehicle cybersecurity (BMS relevant) |
| 53  | UNECE R156 — Software Update                            | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-03/R156e.pdf)                       | OTA updates (BMS firmware)           |
| 54  | UNECE GTR 13 — Hydrogen/Fuel Cell Vehicles              | :white_check_mark: Downloaded | [UNECE](https://unece.org/sites/default/files/2021-09/ECE-TRANS-180-Add.13-Amd.1e.pdf) | Hydrogen battery hybrid systems      |

---

## 3. IEC/ISO Battery Standards

### 3.1 EV Battery Standards (IEC 62660 Series)

| #   | Document                                                     | Status          | URL                                                 | Price | Notes                          |
| --- | ------------------------------------------------------------ | --------------- | --------------------------------------------------- | ----- | ------------------------------ |
| 55  | **IEC 62660-1** — Performance testing (Li-ion cells for EVs) | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/66437) | ~€285 | Cell-level performance testing |
| 56  | **IEC 62660-2** — Reliability and abuse testing              | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/66438) | ~€245 | Abuse and safety testing       |
| 57  | **IEC 62660-3** — Safety requirements                        | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/66439) | ~€245 | Cell safety requirements       |

### 3.2 Stationary/Industrial Battery Standards

| #   | Document                                                             | Status          | URL                                                 | Price | Notes                          |
| --- | -------------------------------------------------------------------- | --------------- | --------------------------------------------------- | ----- | ------------------------------ |
| 58  | **IEC 62619** — Safety for secondary lithium cells (industrial)      | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/62006) | ~€295 | Industrial battery safety      |
| 59  | **IEC 62620** — Performance for secondary lithium cells (industrial) | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/7273)  | ~€245 | Industrial battery performance |
| 60  | **IEC 63056** — Safety for stationary ESS                            | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/29640) | ~€195 | Grid-scale battery safety      |

### 3.3 Portable Battery Standards

| #   | Document                                                     | Status          | URL                                                 | Price | Notes                               |
| --- | ------------------------------------------------------------ | --------------- | --------------------------------------------------- | ----- | ----------------------------------- |
| 61  | **IEC 62133-2** — Safety for portable Li-ion cells/batteries | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/64708) | ~€245 | Consumer electronics battery safety |
| 62  | **IEC 61960-3** — Performance testing for portable Li-ion    | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/62810) | ~€195 | Portable battery performance        |

### 3.4 LMT / Light Electric Vehicle Standards

| #   | Document                                                        | Status          | URL                                                 | Price | Notes                         |
| --- | --------------------------------------------------------------- | --------------- | --------------------------------------------------- | ----- | ----------------------------- |
| 63  | **IEC 63193** — Safety for batteries in light electric vehicles | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/62012) | ~€195 | E-bike, e-scooter batteries   |
| 64  | **EN 50604-1** — Secondary lithium batteries for LEVs           | :moneybag: Paid | [CEN](https://standards.cencenelec.eu/)             | ~€120 | European LEV battery standard |
| 65  | **EN 15194** — EPAC (electrically assisted bicycles)            | :moneybag: Paid | [CEN](https://standards.cencenelec.eu/)             | ~€150 | E-bike complete standard      |

### 3.5 SLI Battery Standards

| #   | Document                                                       | Status          | URL                                               | Price | Notes                            |
| --- | -------------------------------------------------------------- | --------------- | ------------------------------------------------- | ----- | -------------------------------- |
| 66  | **IEC 60095-1** — Lead-acid SLI batteries: General             | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/701) | ~€195 | 12V lead-acid battery            |
| 67  | **IEC 60095-4** — Lead-acid SLI: Dimensions                    | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/703) | ~€120 | Battery form factors             |
| 68  | **EN 50342-1** — Lead-acid starter batteries: General          | :moneybag: Paid | [CEN](https://standards.cencenelec.eu/)           | ~€120 | European SLI standard            |
| 69  | **LV 124** — Electrical testing for HV components (German OEM) | :moneybag: Paid | Private                                           | ~€150 | VW/BMW/Daimler internal standard |

### 3.6 ISO Standards for EVs

| #   | Document                                                    | Status          | URL                                            | Price    | Notes                              |
| --- | ----------------------------------------------------------- | --------------- | ---------------------------------------------- | -------- | ---------------------------------- |
| 70  | **ISO 6469-1** — EV safety: RESS (energy storage)           | :moneybag: Paid | [ISO](https://www.iso.org/standard/68665.html) | ~CHF 178 | Rechargeable energy storage safety |
| 71  | **ISO 6469-2** — EV safety: Operational safety              | :moneybag: Paid | [ISO](https://www.iso.org/standard/68666.html) | ~CHF 138 | Operational safety means           |
| 72  | **ISO 6469-3** — EV safety: Electrical safety               | :moneybag: Paid | [ISO](https://www.iso.org/standard/68667.html) | ~CHF 178 | Protection against electric shock  |
| 73  | **ISO 6469-4** — EV safety: Post-crash electrical safety    | :moneybag: Paid | [ISO](https://www.iso.org/standard/75166.html) | ~CHF 98  | Post-crash safety requirements     |
| 74  | **ISO 12405-4** — EV battery packs and systems: Performance | :moneybag: Paid | [ISO](https://www.iso.org/standard/71407.html) | ~CHF 138 | Pack-level testing                 |
| 75  | **ISO 19453-6** — EV powertrain: Battery safety             | :moneybag: Paid | [ISO](https://www.iso.org/standard/75860.html) | ~CHF 138 | Powertrain battery safety          |
| 76  | **ISO 17546** — Li-ion cells & packs: Shipping              | :moneybag: Paid | [ISO](https://www.iso.org/standard/60049.html) | ~CHF 58  | Lithium battery shipping           |

### 3.7 Functional Safety Standards

| #   | Document                                                       | Status          | URL                                                | Price         | Notes                               |
| --- | -------------------------------------------------------------- | --------------- | -------------------------------------------------- | ------------- | ----------------------------------- |
| 77  | **ISO 26262** (Parts 1-12) — Functional Safety (Road Vehicles) | :moneybag: Paid | [ISO](https://www.iso.org/standard/68383.html)     | ~CHF 178/part | BMS functional safety; ~12 parts    |
| 78  | **IEC 61508** (Parts 1-7) — Functional Safety (General)        | :moneybag: Paid | [IEC](https://webstore.iec.ch/en/publication/5515) | ~€295/part    | Foundation standard for all sectors |
| 79  | **ISO/PAS 19295** — Charging Safety for LEVs                   | :moneybag: Paid | [ISO](https://www.iso.org/standard/64674.html)     | ~CHF 58       | Charging safety for light EVs       |
| 80  | **ISO 21498-1** — EV battery system: General/tests             | :moneybag: Paid | [ISO](https://www.iso.org/standard/80075.html)     | ~CHF 138      | Battery system testing framework    |

### 3.8 Declaration of Conformity Standards

| #   | Document                                                   | Status                        | URL                                                                                 | Price                                | Notes                          |
| --- | ---------------------------------------------------------- | ----------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------ |
| 81  | **ISO/IEC 17050-1** — Supplier's declaration of conformity | :moneybag: Paid               | [ISO](https://www.iso.org/standard/80918.html)                                      | ~CHF 58                              | DoC general requirements       |
| 82  | **ISO/IEC 17050-2** — Supporting documentation for DoC     | :moneybag: Paid               | [ISO](https://www.iso.org/standard/80919.html)                                      | ~CHF 38                              | DoC documentation requirements |
| 83  | **EN ISO/IEC 17065** — Conformity assessment bodies        | :moneybag: Paid               | [ISO](https://www.iso.org/standard/46568.html)                                      | ~CHF 138                             | Product certification bodies   |
| 84  | **Decision 768/2008/EC** — EU DoC framework                | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32008D0768) | EU conformity assessment modules     |
| 84b | **DIN DKE SPEC 99100** — Battery Passport Data Model       | :white_check_mark: Downloaded | Pre-existing                                                                        | German standardization specification |

---

## 4. Battery Passport & Digital Product Passport

| #   | Document                                                    | Status                        | URL                                                                                                                                                         | Notes                                                                                                                                                                                                           |
| --- | ----------------------------------------------------------- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 85  | **Battery Pass — Content Guidance** (2023)                  | :white_check_mark: Downloaded | [Battery Pass](https://thebatterypass.eu/assets/images/content-guidance/pdf/2023_Battery_Passport_Content_Guidance.pdf)                                     | Core data model guidance                                                                                                                                                                                        |
| 86  | **Battery Pass — Technical Guidance** (2024)                | :white_check_mark: Downloaded | [Battery Pass](https://thebatterypass.eu/assets/images/technical-guidance/pdf/2024_BatteryPassport_Technical_Guidance.pdf)                                  | Technical implementation. Battery Pass project ended March 2025, succeeded by BatteryPass-Ready                                                                                                                 |
| 87  | **GBA — Battery Passport Overview** (2024)                  | :white_check_mark: Downloaded | [GBA](https://www.globalbattery.org/media/publications/gba-batterypassport-2024-v1-web.pdf)                                                                 | Supersedes the old "Battery Passport Concept" document                                                                                                                                                          |
| 87b | **GBA — Child Labour Index** v1r2                           | :white_check_mark: Downloaded | [GBA](https://www.globalbattery.org/media/publications/gba-childlaborindex-v1rev2.pdf)                                                                      | Battery Passport sustainability dimension: child labour indicators                                                                                                                                              |
| 87c | **GBA — Human Rights Index** v1r2                           | :white_check_mark: Downloaded | [GBA](https://www.globalbattery.org/media/publications/gba-humanrightsindex-v1rev2.pdf)                                                                     | Battery Passport sustainability dimension: human rights indicators                                                                                                                                              |
| 88  | **GBA — GHG Rulebook** v2.0                                 | :white_check_mark: Downloaded | [GBA](https://www.globalbattery.org/media/publications/gba-rulebook-v2.0-master.pdf)                                                                        | Carbon footprint methodology. URL updated (old `/media/gba-ghg-rulebook.pdf` no longer works). Latest is v2.1 (Sep 2025)                                                                                        |
| 89  | **JRC — Carbon Footprint Rules (EV batteries)**             | :white_check_mark: Downloaded | [EPLCA](https://eplca.jrc.ec.europa.eu/permalink/battery/GRB-CBF_CarbonFootprintRules-EV_June_2023.pdf)                                                     | JRC134254. PDF from EPLCA platform. Policy moved to draft Delegated Act stage (2024)                                                                                                                            |
| 89b | **JRC — Recycling Efficiency Rules** (2024)                 | :white_check_mark: Downloaded | [JRC](https://publications.jrc.ec.europa.eu/repository/handle/JRC137139)                                                                                    | JRC137139. Technical suggestions for recycling efficiency & material recovery under Article 71 of Reg. 2023/1542                                                                                                |
| 90  | **JRC — Carbon Footprint Rules (Industrial batteries)**     | :white_check_mark: Downloaded | [JRC](https://publications.jrc.ec.europa.eu/repository/handle/JRC141282)                                                                                    | JRC141282 (April 2025) — supersedes JRC134519. CFB-IND for batteries >2 kWh without external storage                                                                                                            |
| 91  | **JRC — Raw Materials Information System**                  | :white_check_mark: Downloaded | [JRC](https://publications.jrc.ec.europa.eu/repository/bitstream/JRC132889/JRC132889_01.pdf)                                                                | RMIS methodology                                                                                                                                                                                                |
| 92  | **EC — Battery Regulation FAQ** (4th iteration, April 2025) | :white_check_mark: Downloaded | [EC DG Environment](https://environment.ec.europa.eu/document/download/5f7ff5e2-ebe9-4bd4-a139-db881bd6398f_en?filename=FAQ-UPDATE-4th-Iteration_clean.pdf) | Moved from DG Energy to DG Environment                                                                                                                                                                          |
| 93  | **Catena-X — Battery Passport Standard** (CX-0143)          | :white_check_mark: Scraped    | [Catena-X](https://catenax-ev.github.io/docs/next/standards/CX-0143-UseCaseCircularEconomyDigitalProductPassportStandard/CX-0143-SEM)                       | Old CX-0135 reassigned. Battery Pass data model consolidated into CX-0143 (web-only, no PDF). Battery Pass aspect model v6.1.0. Ingested 2026-03-05 via extractWebKnowledge.js (53 chunks, category: standards) |
| 94  | GBA — Battery Passport Pilot Report                         | :white_check_mark: Scraped    | [GBA](https://www.globalbattery.org/battery-passport/)                                                                                                      | Pilot program results. Ingested 2026-03-05 via extractWebKnowledge.js (9 chunks, category: battery_passport)                                                                                                    |
| 95  | Battery Pass — Data Attribute List                          | :globe_with_meridians: Free   | [Battery Pass](https://thebatterypass.eu/)                                                                                                                  | Detailed attribute definitions                                                                                                                                                                                  |
| 96  | Circular Battery Passport — Lifecycle Data Model            | :globe_with_meridians: Free   | [Battery Pass](https://thebatterypass.eu/)                                                                                                                  | Circular economy data requirements                                                                                                                                                                              |
| 97  | CENELEC — Digital Product Passport standards work           | :globe_with_meridians: Free   | [CEN-CENELEC](https://www.cencenelec.eu/)                                                                                                                   | Standardization in progress                                                                                                                                                                                     |
...
| #   | Document                                                                | Status                        | URL                                                                                                                            | Notes                                                                                         |
| --- | ----------------------------------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| 98  | **OECD — Due Diligence Guidance for Minerals** (3rd ed.)                | :white_check_mark: Downloaded | [OECD](https://www.oecd.org/daf/inv/mne/OECD-Due-Diligence-Guidance-Minerals-Edition3.pdf)                                     | Gold standard for minerals due diligence                                                      |
| 99  | **IRMA Standard v2.0** (2nd Draft) — Responsible Mining                 | :white_check_mark: Downloaded | [IRMA](https://responsiblemining.net/wp-content/uploads/2025/07/IRMAStandardV2.0_2nd-DRAFT-for-Public-Consultation_EN.pdf)     | v2.0 not yet finalized (2nd draft Jul 2025, adoption pending). Current finalized: v1.0 (2018) |
| 100 | **EU Critical Raw Materials Act 2024/1252**                             | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024R1252)                                            | CRM supply chain obligations                                                                  |
| 101 | **EU Conflict Minerals Regulation 2017/821**                            | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32017R0821)                                            | 3TG due diligence                                                                             |
| 102 | **CSDDD 2024/1760**                                                     | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32024L1760)                                            | Corporate due diligence directive                                                             |
| 103 | RMI — Responsible Minerals Initiative tools                             | :globe_with_meridians: Free   | [RMI](https://www.responsiblemineralsinitiative.org/)                                                                          | CMRT, EMRT templates                                                                          |
| 104 | Cobalt Institute — Cobalt Industry Responsible Assessment Framework     | :globe_with_meridians: Free   | [CI](https://www.cobaltinstitute.org/responsible-sourcing/ciraf/)                                                              | Cobalt supply chain framework                                                                 |
| 105 | Copper Mark — Responsible Production Framework                          | :globe_with_meridians: Free   | [Copper Mark](https://coppermark.org/)                                                                                         | Copper/nickel/zinc responsible sourcing                                                       |
| 106 | OECD — Handbook on Environmental Due Diligence in Mineral Supply Chains | :globe_with_meridians: Free   | [OECD](https://www.oecd.org/en/publications/handbook-on-environmental-due-diligence-in-mineral-supply-chains_cef843bf-en.html) | Environmental due diligence guidance                                                          |
| 107 | **UN Guiding Principles on Business and Human Rights**                  | :white_check_mark: Downloaded | [OHCHR](https://www.ohchr.org/sites/default/files/documents/publications/guidingprinciplesbusinesshr_en.pdf)                   | Foundation for human rights due diligence                                                     |
...
| 116 | PHMSA 49 CFR — US Hazardous Materials Transport                  | :globe_with_meridians: Free   | [eCFR](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-I/subchapter-C)      | US federal transport rules                                                                                                                                                                                      |
| 117 | ADN 2025 — Inland Waterway Transport of Dangerous Goods          | :globe_with_meridians: Free   | [UNECE](https://unece.org/transport/dangerous-goods/adn-agreement-and-regulations)   | Waterway transport                                                                                                                                                                                              |

---

## 7. Safety, Recycling & Environmental

### 7.1 Recycling & End-of-Life
...
| 122 | EU Industrial Emissions Directive 2010/75/EU       | :white_check_mark: Downloaded | [EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32010L0075)                     | Emissions from battery manufacturing                                               |
| 123 | BREF — Waste Treatment (Best Available Techniques) | :globe_with_meridians: Free   | [EU BREF](https://eippcb.jrc.ec.europa.eu/reference/waste-treatment)                                    | BAT for battery recycling                                                          |
| 124 | Minamata Convention on Mercury                     | :globe_with_meridians: Free   | [Minamata](https://www.mercuryconvention.org/en/documents/minamata-convention-mercury-text-and-annexes) | Mercury in batteries                                                               |
...
| 129 | UL 9540 — Energy Storage Systems and Equipment            | :moneybag: Paid               | [UL](https://www.shopulstandards.com/)                                                                                       | ~$500                                                                                                                                                                                | ESS safety standard       |
| 130 | UL 9540A — Test Method for Thermal Runaway Propagation    | :moneybag: Paid               | [UL](https://www.shopulstandards.com/)                                                                                       | ~$200                                                                                                                                                                                | Thermal runaway fire test |
| 131 | EPRI — Fire Hazard Assessment for Li-Ion BESS             | :globe_with_meridians: Free   | [EPRI](https://www.epri.com/)                                                                                                | Research publication                                                                                                                                                                 |
| 132 | Euro NCAP — Battery EV Safety Protocols 2025              | :globe_with_meridians: Free   | [Euro NCAP](https://www.euroncap.com/en/for-engineers/protocols/safety-assist/)                                              | EV-specific crash test protocols                                                                                                                                                     |

---

## 8. Functional Safety & Testing

### 8.1 Research & Free Testing Reports
...
| #    | Document                                                  | Status          | Price         | Notes                                                                                                      |
| ---- | --------------------------------------------------------- | --------------- | ------------- | ---------------------------------------------------------------------------------------------------------- |
| 141  | **ISO 26262** Parts 1-12 — Road Vehicle Functional Safety | :moneybag: Paid | ~CHF 178/part | BMS ASIL determination, safety analysis                                                                    |
| 142  | **IEC 61508** Parts 1-7 — Functional Safety (General)     | :moneybag: Paid | ~€295/part    | Foundation for all functional safety                                                                       |
| 143  | **ISO/SAE 21434** — Road Vehicle Cybersecurity            | :moneybag: Paid | ~CHF 178      | BMS cybersecurity engineering                                                                              |
| 144  | **SOTIF ISO 21448** — Safety of Intended Functionality    | :moneybag: Paid | ~CHF 178      | BMS intended function safety                                                                               |
| 145  | **SAE J2464** — EV Battery Abuse Testing                  | :moneybag: Paid | ~$109         | Abuse testing procedures                                                                                   |
...
## 11. Eurasian Economic Union (EAEU)
...
## 14. Global Market & Policy Reports

| #   | Document                                          | Status                        | URL                                                                                                                      | Notes                               |
| --- | ------------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| 201 | **IEA — Global EV Outlook 2024**                  | :white_check_mark: Downloaded | [IEA](https://iea.blob.core.windows.net/assets/a9e3544b-0b12-4e15-b407-65f5c8ce1b5f/GlobalEVOutlook2024.pdf)             | Comprehensive EV market analysis    |
| 202 | **World Bank — Minerals for Climate Action**      | :white_check_mark: Downloaded | [World Bank](https://documents1.worldbank.org/curated/en/099052423172525564/pdf/P16627806f5aa400508f8c0bdcba0878a3e.pdf) | Critical minerals demand            |
| 203 | IEA — Critical Minerals Market Review 2023        | :globe_with_meridians: Free   | [IEA](https://www.iea.org/reports/critical-minerals-market-review-2023)                                                  | Minerals market analysis            |
| 204 | BloombergNEF — Battery Price Survey 2024          | :lock: Auth                   | [BNEF](https://about.bnef.com/)                                                                                          | Bloomberg subscription required     |
| 205 | McKinsey — Battery 2030                           | :lock: Auth                   | [McKinsey](https://www.mckinsey.com/)                                                                                    | Industry analysis                   |
| 206 | World Economic Forum — Battery Value Chain        | :globe_with_meridians: Free   | [WEF](https://www.weforum.org/)                                                                                          | Global battery value chain analysis |
| 207 | IRENA — Electricity Storage Valuation Framework   | :globe_with_meridians: Free   | [IRENA](https://www.irena.org/publications/2020/Mar/Electricity-Storage-Valuation-Framework-2020)                        | Storage economics                   |
| 208 | European Battery Alliance — Strategic Action Plan | :globe_with_meridians: Free   | [EBA](https://www.eba250.com/)                                                                                           | EU battery industrial strategy      |

---

## Download Statistics

| Category                            | Downloaded  | Converted to MD                 | Free (Not Downloaded) | Auth Required | Paid   | Total   |
| ----------------------------------- | ----------- | ------------------------------- | --------------------- | ------------- | ------ | ------- |
| EU Battery Regulation & Legislation | 27          | 27                              | 8                     | 0             | 0      | 35      |
| UNECE Homologation                  | 27          | 27                              | 0                     | 0             | 0      | 27      |
| IEC/ISO Standards                   | 0           | 0                               | 0                     | 0             | 30     | 30      |
| Battery Passport                    | 16          | 16                              | 2                     | 0             | 0      | 18      |
| Supply Chain                        | 5           | 5                               | 1                     | 0             | 0      | 7       |
| Transport of Dangerous Goods        | 6           | 6                               | 1                     | 0             | 3      | 10      |
| Safety/Recycling/Environmental      | 1           | 1                               | 4                     | 1             | 5      | 11      |
| Functional Safety & Testing         | 11 + 32 ERG | 11 + 32 ERG                     | 0                     | 0             | 8      | 51      |
| China                               | 4           | 3 (+1 excluded non-extractable) | 3                     | 0             | 5      | 12      |
| ASEAN                               | 5           | 5                               | 1                     | 0             | 3      | 9       |
| EAEU                                | 1           | 1                               | 4                     | 0             | 1      | 6       |
| Middle East                         | 5           | 5                               | 0                     | 0             | 5      | 10      |
| Africa                              | 17          | 17                              | 0                     | 0             | 0      | 17      |
| Global Reports                      | 4           | 0                               | 2                     | 2             | 0      | 8       |
| **TOTAL**                           | **161**     | **159**                         | **26**                | **3**         | **60** | **251** |

> **Note**: 161 unique PDF files are currently downloaded in `server/knowledge-base/pdfs/` (incl. 32 NHTSA ERG guides and 27 UNECE regulations with amendments). 159 have been converted to markdown and ingested into Firestore. 1 file (`china/UNECE_GB38031_Revision_Status_SIGTP-01-11`) converted to only 309 bytes (scanned presentation slide, non-extractable). Strict completeness keeps China baseline at 4 downloaded PDFs but applies a deterministic single-file exclusion for this non-extractable source. 1 file (`iec-iso-standards/Decision_768_2008_EC` + `DIN_DKE_SPEC_99100`) counted in IEC/ISO but actually stored in `battery-passport/`. Many listed "free" documents are web pages rather than downloadable PDFs. Several regional standards (Indonesia SNI, Philippines PNS, Malaysia MS, GSO/ESMA/Qatar) were reclassified from Free to Paid.
...
6. GBA — Battery Passport Concept (#87)
7. JRC — Carbon Footprint Rules EV (#89)
8. Catena-X — Battery Passport Standard (#93)
9. UNECE R100 Rev.3 — EV Safety (#36)
10. UNECE GTR 20 — EV Safety Global (#38)
11. UNECE GTR 22 — Battery Durability (#39)
12. OECD — Minerals Due Diligence (#98)
13. EU Conflict Minerals Reg. (#101)
14. CSDDD (#102)
15. UN Manual of Tests — Section 38.3 (#108)
16. ADR 2025 (#110-111)
17. GB 38031-2020 — China EV Battery (#149)
18. IEA Global EV Outlook 2024 (#201)
19. EU Critical Raw Materials Act (#100)
20. IRMA Standard v2.0 (#99)
...
└── pdfs/                                    ← Git-ignored (large binaries)
    ...
    ├── functional-safety/           # 11 PDFs + 32 NHTSA ERG guides in subfolder
    ...
    └── africa/                      # 17 PDFs — AU Mining Vision, AfCFTA, IEA/IRENA Africa, World Bank DRC, DRC/Nigeria/Tanzania/Ghana/Zimbabwe/Zambia mining acts, SADC, AMDC, Morocco, SA Energy, Kenya Energy
```

### Download Script

To download PDFs automatically (opens a browser for CAPTCHA-protected sites):

```bash
# All sources:
node server/scripts/downloadKnowledgeBase.mjs --all

# EUR-Lex only (auto-downloads after WAF challenge):
node server/scripts/downloadKnowledgeBase.mjs --eurlex

# UNECE only (requires manual CAPTCHA solve):
...
**Conversion & ingestion completed**: All 161 downloaded PDFs have been processed through the knowledge extraction pipeline. 159 files successfully converted to markdown and ingested into Firestore. State markers (`.converted` + `.ingested`) are present and consistent for all ingestible files. No unresolved pipeline failures remain.

**Known non-extractable files**:

- `china/UNECE_GB38031_Revision_Status_SIGTP-01-11.pdf` — Scanned presentation slide, only 309 bytes extracted. Content is a single sentence about GB 38031 revision timeline. Flagged as non-extractable (below 1KB quality threshold) and explicitly excluded by strict completeness logic.

**Verification**: Run `node server/scripts/verifyFirestoreIngestion.js --all --disk-check --strict --show-docs 3` to audit Firestore counts, disk integrity, and quality metrics.

## Next Steps

1. **Purchase priority IEC/ISO standards** as budget allows (estimated ~5,000-8,000 EUR for core set)
2. **Monitor EUR-Lex** for pending implementing/delegated regulations (items 6-13)
3. **Set up automated alerts** for regulatory updates via EUR-Lex notifications
4. **Expand regional coverage** with country-specific standards as market entry requires
5. **Re-run Firestore verification** when quota resets to confirm ingestion doc counts (quota was exhausted during last audit attempt)

---

## Manual Download Checklist

> **Instructions**: Download each PDF manually and save it in the indicated folder under `server/knowledge-base/pdfs/`. After you're done, ask Claude to recheck the folder and clean up this list.
>
...
_Generated for Ichnos Protocol Battery Passport Knowledge Base_
_Last updated: 2026-02-18 — 120 PDFs downloaded across all categories. All free downloadable PDFs obtained. Only 2 web-only sources (Catena-X, GBA) remain for scraping. Paid standards (IEC/ISO, regional) not included._
